    ...
    <PageLayout currentPage="line-items" onNavigate={onNavigate}>
      <div className="max-w-[900px]">
        ...
        <div className="flex flex-col gap-4 lg:gap-[24px]">
          {lineItems.map((item) => (
            <div key={item.id} className="bg-white rounded-[14px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)] border border-[#e2e8f0] p-4 lg:p-[25px]">
              {/* Header */}
              <div className="flex items-start justify-between mb-4 lg:mb-[16px]">
                <div className="flex-1">
                  <h2 className="font-['Source_Sans_3:Bold',sans-serif] leading-tight text-[#0f172b] text-[20px] lg:text-[28px] mb-[8px]">
                    {item.title}
                  </h2>
                  <div className="flex flex-col lg:flex-row lg:gap-[12px] lg:items-center gap-1 flex-wrap">
