...
export default function PageSidebar() {
  return (
    <div className="w-[324px] sticky top-[97px] h-[calc(100vh-97px)] bg-white p-[24px] overflow-y-auto flex-shrink-0">
      {/* Search */}
      ...
      {/* Filters */}
      <div>
        <p className="font-['Source_Sans_3:Bold',sans-serif] leading-[20px] text-[#0f172b] text-[14px] mb-[16px]">Filters</p>
