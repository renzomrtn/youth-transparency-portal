import svgPaths from "./svg-r5c8mpqd2y";
...
function Text3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[137.828px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#45556c] text-[14px] top-0 w-[138px]">Category: PPA</p>
      </div>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#0f172b] text-[14px] top-0 w-[175px]">
...
function Paragraph4() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#101828] text-[14px] top-0 w-[101px]">₱55,555.56</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="absolute h-[20px] left-0 top-[28px] w-[272.656px]" data-name="Paragraph">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#0f172b] text-[14px] top-0 w-[122px]">September 2025</p>
    </div>
  );
}
...
function Heading3() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="absolute font-['Source_Sans_3:Medium',sans-serif] font-medium leading-[32px] left-0 text-[#0f172b] text-[24px] text-nowrap top-[-1px]">Anti-Illegal Drugs Seminar</p>
    </div>
  );
}
...
function Paragraph10() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#0f172b] text-[14px] top-0 w-[232px]">
        <span className="font-['Source_Sans_3:Bold',sans-serif] font-bold">Area of Participation:</span>
...
function Paragraph14() {
  return (
    <div className="absolute h-[20px] left-0 top-[28px] w-[272.656px]" data-name="Paragraph">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#0f172b] text-[14px] top-0 w-[122px]">January 2025</p>
    </div>
  );
}
...
function Heading4() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="absolute font-['Source_Sans_3:Medium',sans-serif] font-medium leading-[32px] left-0 text-[#0f172b] text-[24px] text-nowrap top-[-1px]">Leadership Training Camp</p>
    </div>
  );
}
...
function Paragraph22() {
  return (
    <div className="absolute h-[20px] left-0 top-[28px] w-[272.656px]" data-name="Paragraph">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#0f172b] text-[14px] top-0 w-[122px]">March 2025</p>
    </div>
  );
}
...
function Heading5() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="absolute font-['Source_Sans_3:Medium',sans-serif] font-medium leading-[32px] left-0 text-[#0f172b] text-[24px] text-nowrap top-[-1px]">Inter-Barangay Sports League</p>
    </div>
  );
}
...
function Paragraph26() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#0f172b] text-[14px] top-0 w-[186px]">
        <span className="font-['Source_Sans_3:Bold',sans-serif] font-bold">Area of Participation:</span>
        <span>{` Sports`}</span>
      </p>
    </div>
...
function Paragraph30() {
  return (
    <div className="absolute h-[20px] left-0 top-[28px] w-[272.656px]" data-name="Paragraph">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#0f172b] text-[14px] top-0 w-[122px]">April 2025</p>
    </div>
  );
}
...
function Container24() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[1000px] items-start left-[637px] top-[197px] w-[916px]" data-name="Container">
      <Container5 />
      <Container11 />
      <Container17 />
      <Container23 />
...
function Heading7() {
  return (
    <div className="absolute h-[40px] left-[643px] top-[139px] w-[916px]" data-name="Heading 2">
      <p className="absolute font-['Source_Sans_3:Bold',sans-serif] font-bold leading-[40px] left-0 text-[#0f172b] text-[36px] text-nowrap top-0">LINE ITEMS</p>
    </div>
  );
}
...
function CardChecklist() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="card-checklist 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_5_2906)" id="card-checklist 1">
          <path d={svgPaths.p3cb26100} fill="var(--fill-0, white)" id="Vector" />
          <path d={svgPaths.p530d400} fill="var(--fill-0, white)" id="Vector_2" />
        </g>
        <defs>
...
function App2() {
  return (
    <div className="h-[24px] relative shrink-0 w-[81px]" data-name="App">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Source_Sans_3:SemiBold',sans-serif] font-semibold leading-[24px] left-[calc(50%-0.31px)] text-[16px] text-center text-nowrap text-white top-0 translate-x-[-50%]">Line Items</p>
      </div>
    </div>
  );
}
...
function Button10() {
  return (
    <div className="bg-[#174499] h-[40px] relative rounded-[10px] shrink-0 w-[133px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center px-[16px] py-0 relative size-full">
        <CardChecklist />
        <App2 />
      </div>
...
export default function LineItems() {
  return (
    <div className="bg-white relative size-full" data-name="Line Items">
      <Container24 />
      <ProjectsPage8 />
      <Container35 />
      <Heading7 />
