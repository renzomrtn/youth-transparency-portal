import svgPaths from "./svg-6mr85zt7dg";
...
function Heading1() {
  return (
    <div className="absolute h-[48px] left-0 top-[48px] w-[896px]" data-name="Heading 2">
      <p className="absolute font-['Source_Sans_3:Bold',sans-serif] font-bold leading-[48px] left-[447.86px] text-[48px] text-center text-nowrap text-white top-0 translate-x-[-50%]">Welcome to the Youth Transparency Portal</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="absolute h-[97.5px] left-0 top-[120px] w-[896px]" data-name="Paragraph">
      <p className="absolute font-['Source_Sans_3:Medium',sans-serif] font-medium leading-[32.5px] left-[448.39px] text-[#dbeafe] text-[20px] text-center top-0 translate-x-[-50%] w-[860px]">A platform dedicated to transparency and public accountability, providing direct access to the official records, documents, and financial reports of the Sangguniang Kabataan Federation and across all 27 SK barangay councils of Naga City.</p>
    </div>
  );
}
...
function Section() {
  return (
    <div className="absolute h-[409.5px] left-0 overflow-clip top-[97px] w-[1905px]" data-name="Section" style={{ backgroundImage: "linear-gradient(167.868deg, rgb(21, 93, 252) 0%, rgb(20, 71, 230) 50%, rgb(55, 42, 172) 100%)" }}>
      <Container />
      <Container1 />
    </div>
  );
...
function Container2() {
  return (
    <div className="relative rounded-[14px] shrink-0 size-[48px]" data-name="Container" style={{ backgroundImage: "linear-gradient(135deg, rgb(173, 70, 255) 0%, rgb(152, 16, 250) 100%)" }}>
...
function Text() {
  return (
    <div className="bg-[#faf5ff] h-[24px] relative rounded-[3.35544e+07px] shrink-0 w-[54.406px]" data-name="Text">
...
function Heading2() {
  return (
    <div className="h-[32px] overflow-clip relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[32px] left-0 text-[#0f172b] text-[24px] text-nowrap top-[-1px]">FEDERATION</p>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="[grid-area:1_/_1] bg-white h-[178px] justify-self-stretch relative rounded-[16px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#f1f5f9] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)]" />
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.p35b02000} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M16 10H16.01" id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p127dad40} id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Container5() {
  return (
    <div className="relative rounded-[14px] shrink-0 size-[48px]" data-name="Container" style={{ backgroundImage: "linear-gradient(135deg, rgb(0, 201, 80) 0%, rgb(0, 166, 62) 100%)" }}>
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Icon2 />
      </div>
    </div>
...
function Text1() {
  return (
    <div className="bg-[#f0fdf4] h-[24px] relative rounded-[3.35544e+07px] shrink-0 w-[47.859px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function App() {
  return (
    <div className="content-stretch flex h-[48px] items-center justify-between relative shrink-0 w-full" data-name="App">
      <Container5 />
      <Text1 />
    </div>
  );
...
function App1() {
  return (
    <div className="h-[36px] relative shrink-0 w-full" data-name="App">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[36px] left-0 text-[#0f172b] text-[30px] text-nowrap top-0">₱500,000</p>
    </div>
  );
}
...
function Icon3() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d={svgPaths.pb007f00} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p1b58ab00} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
...
function Container7() {
  return (
    <div className="relative rounded-[14px] shrink-0 size-[48px]" data-name="Container" style={{ backgroundImage: "linear-gradient(135deg, rgb(255, 105, 0) 0%, rgb(245, 73, 0) 100%)" }}>
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Icon3 />
      </div>
    </div>
...
function App3() {
  return (
    <div className="content-stretch flex h-[48px] items-center relative shrink-0" data-name="App">
      <Container7 />
    </div>
  );
}
...
function App4() {
  return (
    <div className="h-[36px] relative shrink-0 w-full" data-name="App">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[36px] left-0 text-[#0f172b] text-[30px] text-nowrap top-0">156</p>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="[grid-area:1_/_5] bg-white place-self-stretch relative rounded-[16px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#f1f5f9] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)]" />
      <div className="size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start pb-px pt-[25px] px-[25px] relative size-full">
          <App3 />
...
function Container9() {
  return (
    <div className="relative rounded-[14px] shrink-0 size-[48px]" data-name="Container" style={{ backgroundImage: "linear-gradient(135deg, rgb(43, 127, 255) 0%, rgb(21, 93, 252) 100%)" }}>
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <Icon4 />
      </div>
    </div>
...
function App7() {
  return (
    <div className="h-[36px] relative shrink-0 w-full" data-name="App">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[36px] left-0 text-[#0f172b] text-[30px] text-nowrap top-0">43</p>
    </div>
  );
}
...
function CardChecklist1() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="card-checklist 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="card-checklist 2">
          <path d={svgPaths.p5214180} fill="var(--fill-0, white)" id="Vector" />
          <path d={svgPaths.p324bca80} fill="var(--fill-0, white)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Container11() {
  return (
    <div className="bg-[#cc2bbb] content-stretch flex items-center justify-center relative rounded-[14px] shrink-0 size-[48px]" data-name="Container">
      <CardChecklist1 />
    </div>
  );
}
...
function App9() {
  return (
    <div className="h-[36px] relative shrink-0 w-full" data-name="App">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[36px] left-0 text-[#0f172b] text-[30px] text-nowrap top-0">50</p>
    </div>
  );
}
...
function Section1() {
  return (
    <div className="absolute gap-[24px] grid grid-cols-[repeat(5,_minmax(0px,_1fr))] grid-rows-[repeat(2,_minmax(0px,_1fr))] h-[388px] left-[calc(50%+0.5px)] top-[407px] translate-x-[-50%] w-[1546px]" data-name="Section">
      <Container4 />
      <Container6 />
      <Container8 />
      <Container10 />
...
function Heading3() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Heading 2">
      <p className="font-['Source_Sans_3:Medium',sans-serif] font-medium leading-[30px] relative shrink-0 text-[#101828] text-[24px] text-nowrap">Recent Activity</p>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[82px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#45556c] text-[14px] top-0 w-[124px]">SK Federation</p>
      </div>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="h-[20px] relative shrink-0 w-[137.828px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#4a5565] text-[14px] top-0 w-[138px]">Verified Expenses</p>
      </div>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="h-[48px] relative shrink-0 w-[212px]" data-name="Container">
...
function Text5() {
  return (
    <div className="h-[20px] relative shrink-0 w-[74px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#6a7282] text-[14px] text-nowrap">Sep 13, 2025</p>
      </div>
    </div>
  );
}
...
function Container16() {
  return (
    <div className="content-stretch flex h-[48px] items-center justify-between relative shrink-0 w-[1496px]" data-name="Container">
      <Container15 />
      <Text5 />
    </div>
  );
...
function Container19() {
  return (
    <div className="h-[48px] relative shrink-0 w-[174px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[4px] items-start relative size-full">
        <Paragraph3 />
        <Container18 />
      </div>
...
function Text9() {
  return (
    <div className="h-[20px] relative shrink-0 w-[74px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#6a7282] text-[14px] text-nowrap">Sep 12, 2025</p>
      </div>
    </div>
  );
}
...
function Container23() {
  return (
    <div className="h-[48px] relative shrink-0 w-[175px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[4px] items-start relative size-full">
        <Paragraph4 />
        <Container22 />
      </div>
...
function Text13() {
  return (
    <div className="h-[20px] relative shrink-0 w-[73px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#6a7282] text-[14px] text-nowrap">Sep 11, 2025</p>
      </div>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[24px] left-0 text-[#101828] text-[16px] text-nowrap top-0">Inter-Barangay Sports League</p>
    </div>
  );
}
...
function Container27() {
  return (
    <div className="h-[48px] relative shrink-0 w-[198px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[4px] items-start relative size-full">
        <Paragraph5 />
        <Paragraph6 />
        <Container26 />
...
function Text17() {
  return (
    <div className="h-[20px] relative shrink-0 w-[73px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Source_Sans_3:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#6a7282] text-[14px] text-nowrap">Sep 10, 2025</p>
      </div>
    </div>
  );
}
...
function Recent() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-start left-[180px] p-px rounded-[10px] top-[636px] w-[1546px]" data-name="Recent">
...
function App11() {
  return (
    <div className="absolute h-[1092px] left-0 top-0 w-[1905px]" data-name="App" style={{ backgroundImage: "linear-gradient(150.177deg, rgb(248, 250, 252) 0%, rgb(239, 246, 255) 50%, rgb(241, 245, 249) 100%)" }}>
      <Section />
      <Section1 />
      <Recent />
    </div>
  ...
  return (
    <div className="absolute left-[1454px] rounded-[3.35544e+07px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] size-[105px] top-[80px]" data-name="Image (SK Logo)">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[3.35544e+07px]">
        ...
        <img alt="" className="absolute max-w-none object-50%-50% object-cover rounded-[3.35544e+07px] size-full" src={imgImageSkLogo} />
      </div>
    </div>
  );
}
...
function Paragraph8() {
  return (
    <div className="absolute bg-[#0f172b] h-[276px] left-0 top-[1092px] w-[1905px]" data-name="Paragraph">
      <Container33 />
  ...
  return (
    <div className="relative rounded-[3.35544e+07px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] shrink-0 size-[64px]" data-name="Image (Logo)">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[3.35544e+07px]">
        ...
        <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid max-w-none object-50%-50% object-cover rounded-[3.35544e+07px] size-full" src={imgImageSkLogo} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p3a151200} id="Vector" stroke="var(--stroke-0, #FDFDFD)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p18af2500} id="Vector_2" stroke="var(--stroke-0, #FDFDFD)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function App16() {
  return (
    <div className="basis-0 grow h-[24px] min-h-px min-w-px relative shrink-0" data-name="App">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Source_Sans_3:SemiBold',sans-serif] font-semibold leading-[24px] left-[20.5px] text-[#fdfdfd] text-[16px] text-center text-nowrap top-0 translate-x-[-50%]">Home</p>
      </div>
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-[#174499] h-[40px] relative rounded-[10px] shrink-0 w-[96.313px]" data-name="Button">
